...
Aufgrund der Probleme, die bereits in der ~\nameref{sec:Projektbegruendung} und der ~\nameref{sec:IstAnalyse} beschrieben wurden, ist ersichtlich, wie wichtig und hilfreich dieses Projekt ist. Trotzdem wurde im folgenden Abschnitt analysieren ob die Umsetzung auch aus wirtschaftlichen Gesichtspunkten gerechtfertigt ist.
...
Der Rechnung zufolge beträgt der Stundensatz eines Azubis ca. 7€.
...
Es ergabt sich also ein Stundensatz von 0.3€ für die Hardware. Sonstige wesentliche Kosten neben den Hardwarekosten sind natürlich auch Arbeitsplatz, Möblierung, Strom, Internet und Lizenzen, welche einen Großteil der Ressourcenkosten ausmachen. Durch grobe Hochrechnung dieser ergaben sich Ressourcenkosten(ohne Personal) von ca. \eur{10} als Stundensatz.
...
Sowie die Wirtschaftlichkeitsanalyse als auch die Nutzwertanalyse, in welchem das Order Comment Tool mit 123 Punkten der klare Gewinner ist, haben gezeigt wie sinnvoll und hilfreich diese Projekt ist.
